...
@JsonKey(fromJson: looseStringFromJson) String get id;@JsonKey(fromJson: looseStringFromJson) String get salonId;@JsonKey(fromJson: looseStringFromJson) String get name;@JsonKey(fromJson: looseStringFromJson) String get serviceName;@JsonKey(fromJson: looseIntFromJson) int get durationMinutes;@JsonKey(fromJson: looseDoubleFromJson) double get price;@JsonKey(fromJson: nullableLooseStringFromJson) String? get description;/// System category key, e.g. [ServiceCategoryKeys.hair], [ServiceCategoryKeys.other].
...
@JsonKey(fromJson: nullableLooseStringFromJson) String? get category;/// Optional marketing image URL (owner catalog / future customer UI).
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,salonId,name,serviceName,durationMinutes,price,description,categoryKey,categoryLabel,customCategoryName,category,imageUrl,timesUsed,totalRevenue,isActive,bookable,createdAt,updatedAt);

@override
String toString() {
  return 'SalonService(id: $id, salonId: $salonId, name: $name, serviceName: $serviceName, durationMinutes: $durationMinutes, price: $price, description: $description, categoryKey: $categoryKey, categoryLabel: $categoryLabel, customCategoryName: $customCategoryName, category: $category, imageUrl: $imageUrl, timesUsed: $timesUsed, totalRevenue: $totalRevenue, isActive: $isActive, bookable: $bookable, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: looseStringFromJson) String id,@JsonKey(fromJson: looseStringFromJson) String salonId,@JsonKey(fromJson: looseStringFromJson) String name,@JsonKey(fromJson: looseStringFromJson) String serviceName,@JsonKey(fromJson: looseIntFromJson) int durationMinutes,@JsonKey(fromJson: looseDoubleFromJson) double price,@JsonKey(fromJson: nullableLooseStringFromJson) String? description,@JsonKey(fromJson: nullableLooseStringFromJson) String? categoryKey,@JsonKey(fromJson: nullableLooseStringFromJson) String? categoryLabel,@JsonKey(fromJson: nullableLooseStringFromJson) String? customCategoryName,@JsonKey(fromJson: nullableLooseStringFromJson) String? category,@JsonKey(fromJson: nullableLooseStringFromJson) String? imageUrl,@JsonKey(fromJson: nullableLooseIntFromJson) int? timesUsed,@JsonKey(fromJson: nullableLooseDoubleFromJson) double? totalRevenue,@JsonKey(fromJson: trueBoolFromJson) bool isActive,@JsonKey(fromJson: trueBoolFromJson) bool bookable,@JsonKey(fromJson: nullableFirestoreDateTimeFromJson, toJson: nullableFirestoreDateTimeToJson) DateTime? createdAt,@JsonKey(fromJson: nullableFirestoreDateTimeFromJson, toJson: nullableFirestoreDateTimeToJson) DateTime? updatedAt
});
...
/// Create a copy of SalonService
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? salonId = null,Object? name = null,Object? serviceName = null,Object? durationMinutes = null,Object? price = null,Object? description = freezed,Object? categoryKey = freezed,Object? categoryLabel = freezed,Object? customCategoryName = freezed,Object? category = freezed,Object? imageUrl = freezed,Object? timesUsed = freezed,Object? totalRevenue = freezed,Object? isActive = null,Object? bookable = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: looseStringFromJson)  String id, @JsonKey(fromJson: looseStringFromJson)  String salonId, @JsonKey(fromJson: looseStringFromJson)  String name, @JsonKey(fromJson: looseStringFromJson)  String serviceName, @JsonKey(fromJson: looseIntFromJson)  int durationMinutes, @JsonKey(fromJson: looseDoubleFromJson)  double price, @JsonKey(fromJson: nullableLooseStringFromJson)  String? description, @JsonKey(fromJson: nullableLooseStringFromJson)  String? categoryKey, @JsonKey(fromJson: nullableLooseStringFromJson)  String? categoryLabel, @JsonKey(fromJson: nullableLooseStringFromJson)  String? customCategoryName, @JsonKey(fromJson: nullableLooseStringFromJson)  String? category, @JsonKey(fromJson: nullableLooseStringFromJson)  String? imageUrl, @JsonKey(fromJson: nullableLooseIntFromJson)  int? timesUsed, @JsonKey(fromJson: nullableLooseDoubleFromJson)  double? totalRevenue, @JsonKey(fromJson: trueBoolFromJson)  bool isActive, @JsonKey(fromJson: trueBoolFromJson)  bool bookable, @JsonKey(fromJson: nullableFirestoreDateTimeFromJson, toJson: nullableFirestoreDateTimeToJson)  DateTime? createdAt, @JsonKey(fromJson: nullableFirestoreDateTimeFromJson, toJson: nullableFirestoreDateTimeToJson)  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SalonService() when $default != null:
return $default(_that.id,_that.salonId,_that.name,_that.serviceName,_that.durationMinutes,_that.price,_that.description,_that.categoryKey,_that.categoryLabel,_that.customCategoryName,_that.category,_that.imageUrl,_that.timesUsed,_that.totalRevenue,_that.isActive,_that.bookable,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: looseStringFromJson)  String id, @JsonKey(fromJson: looseStringFromJson)  String salonId, @JsonKey(fromJson: looseStringFromJson)  String name, @JsonKey(fromJson: looseStringFromJson)  String serviceName, @JsonKey(fromJson: looseIntFromJson)  int durationMinutes, @JsonKey(fromJson: looseDoubleFromJson)  double price, @JsonKey(fromJson: nullableLooseStringFromJson)  String? description, @JsonKey(fromJson: nullableLooseStringFromJson)  String? categoryKey, @JsonKey(fromJson: nullableLooseStringFromJson)  String? categoryLabel, @JsonKey(fromJson: nullableLooseStringFromJson)  String? customCategoryName, @JsonKey(fromJson: nullableLooseStringFromJson)  String? category, @JsonKey(fromJson: nullableLooseStringFromJson)  String? imageUrl, @JsonKey(fromJson: nullableLooseIntFromJson)  int? timesUsed, @JsonKey(fromJson: nullableLooseDoubleFromJson)  double? totalRevenue, @JsonKey(fromJson: trueBoolFromJson)  bool isActive, @JsonKey(fromJson: trueBoolFromJson)  bool bookable, @JsonKey(fromJson: nullableFirestoreDateTimeFromJson, toJson: nullableFirestoreDateTimeToJson)  DateTime? createdAt, @JsonKey(fromJson: nullableFirestoreDateTimeFromJson, toJson: nullableFirestoreDateTimeToJson)  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _SalonService():
return $default(_that.id,_that.salonId,_that.name,_that.serviceName,_that.durationMinutes,_that.price,_that.description,_that.categoryKey,_that.categoryLabel,_that.customCategoryName,_that.category,_that.imageUrl,_that.timesUsed,_that.totalRevenue,_that.isActive,_that.bookable,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: looseStringFromJson)  String id, @JsonKey(fromJson: looseStringFromJson)  String salonId, @JsonKey(fromJson: looseStringFromJson)  String name, @JsonKey(fromJson: looseStringFromJson)  String serviceName, @JsonKey(fromJson: looseIntFromJson)  int durationMinutes, @JsonKey(fromJson: looseDoubleFromJson)  double price, @JsonKey(fromJson: nullableLooseStringFromJson)  String? description, @JsonKey(fromJson: nullableLooseStringFromJson)  String? categoryKey, @JsonKey(fromJson: nullableLooseStringFromJson)  String? categoryLabel, @JsonKey(fromJson: nullableLooseStringFromJson)  String? customCategoryName, @JsonKey(fromJson: nullableLooseStringFromJson)  String? category, @JsonKey(fromJson: nullableLooseStringFromJson)  String? imageUrl, @JsonKey(fromJson: nullableLooseIntFromJson)  int? timesUsed, @JsonKey(fromJson: nullableLooseDoubleFromJson)  double? totalRevenue, @JsonKey(fromJson: trueBoolFromJson)  bool isActive, @JsonKey(fromJson: trueBoolFromJson)  bool bookable, @JsonKey(fromJson: nullableFirestoreDateTimeFromJson, toJson: nullableFirestoreDateTimeToJson)  DateTime? createdAt, @JsonKey(fromJson: nullableFirestoreDateTimeFromJson, toJson: nullableFirestoreDateTimeToJson)  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _SalonService() when $default != null:
return $default(_that.id,_that.salonId,_that.name,_that.serviceName,_that.durationMinutes,_that.price,_that.description,_that.categoryKey,_that.categoryLabel,_that.customCategoryName,_that.category,_that.imageUrl,_that.timesUsed,_that.totalRevenue,_that.isActive,_that.bookable,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _SalonService extends SalonService {
  const _SalonService({@JsonKey(fromJson: looseStringFromJson) required this.id, @JsonKey(fromJson: looseStringFromJson) required this.salonId, @JsonKey(fromJson: looseStringFromJson) required this.name, @JsonKey(fromJson: looseStringFromJson) this.serviceName = '', @JsonKey(fromJson: looseIntFromJson) required this.durationMinutes, @JsonKey(fromJson: looseDoubleFromJson) required this.price, @JsonKey(fromJson: nullableLooseStringFromJson) this.description, @JsonKey(fromJson: nullableLooseStringFromJson) this.categoryKey, @JsonKey(fromJson: nullableLooseStringFromJson) this.categoryLabel, @JsonKey(fromJson: nullableLooseStringFromJson) this.customCategoryName, @JsonKey(fromJson: nullableLooseStringFromJson) this.category, @JsonKey(fromJson: nullableLooseStringFromJson) this.imageUrl, @JsonKey(fromJson: nullableLooseIntFromJson) this.timesUsed, @JsonKey(fromJson: nullableLooseDoubleFromJson) this.totalRevenue, @JsonKey(fromJson: trueBoolFromJson) this.isActive = true, @JsonKey(fromJson: trueBoolFromJson) this.bookable = true, @JsonKey(fromJson: nullableFirestoreDateTimeFromJson, toJson: nullableFirestoreDateTimeToJson) this.createdAt, @JsonKey(fromJson: nullableFirestoreDateTimeFromJson, toJson: nullableFirestoreDateTimeToJson) this.updatedAt}): super._();
...
/// Create a copy of SalonService
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? salonId = null,Object? name = null,Object? serviceName = null,Object? durationMinutes = null,Object? price = null,Object? description = freezed,Object? categoryKey = freezed,Object? categoryLabel = freezed,Object? customCategoryName = freezed,Object? category = freezed,Object? imageUrl = freezed,Object? timesUsed = freezed,Object? totalRevenue = freezed,Object? isActive = null,Object? bookable = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
